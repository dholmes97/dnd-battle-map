...
export const MAX_COMBAT_ACTIONS_PER_OWNER = 24;
export const MAX_COMBAT_ROLLS_PER_ENCOUNTER = 2_000;
export const MAX_PENDING_DAMAGE_PROPOSALS_PER_ENCOUNTER = 100;
